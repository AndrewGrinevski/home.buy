                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="{{ route('home.addSellRoom.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group mx-sm-3 mb-2 form-inline">
                                        ...
                                        <input type="number" class="form-control form-inline" placeholder="Продаваемая" name="sells_area">
