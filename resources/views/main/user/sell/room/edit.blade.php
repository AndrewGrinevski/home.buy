                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="{{ route('home.addRoom.update', ['sell'=>$sellRoom->id ]) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group mx-sm-3 mb-2 form-inline">
                                        ...
                                        <input type="number" class="form-control form-inline" placeholder="Продаваемая" name="living_area" value="{{ $sellRoom->sells_area }}">
