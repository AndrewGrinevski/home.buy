                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="{{ route('home.addRentApartment.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control input-flat" name="rent_per_day">
                                        @error('rent_per_day')
                                        <br>
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <label class="mb-1">(Не обязательно)</label>
                                        <input type="number" class="form-control input-flat" name="rent_per_night">
                                    </div>
                                    <div class="form-group">
                                        <label class="mb-1">Цена на часы</label>
                                        <br>
                                        <label class="mb-1">(Не обязательно)</label>
                                        <input type="number" class="form-control input-flat" name="rent_per_hour">
                                    </div>
                                    <br>
