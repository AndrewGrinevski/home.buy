...
class AddRentApartamentRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'rent_per_day' => 'required|numeric|min:1',
        ];
    }
    ...
    public function messages()
    {
        $messages = [
            ...
            'rent_per_day.min' => 'Поле Цена должно содержать не менее :min символов',
        ];
