...
class AddSellRoomController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        return view('main.user.sell.room.create', compact('rooms','separatedRooms',
    ...
    public function edit($id)
    {
        ...
        return view('main.user.sell.room.edit', compact('sellRoom', 'rooms','separatedRooms',
            'balconies', 'bathrooms', 'repairs', 'walls', 'transactions'));
    }
